...
//TODO: correct the following MACRO-Functions (something is missing in ervery line)
#define TWI_sendSTART()         TWCR = (1<<TWINT) | (1<<TWEN) | (1 << TWIE); gl_uc_twi_busy = 1
#define TWI_sendSTOP()          TWCR = (1<<TWINT) | (1<<TWEN) | (1 << TWIE); gl_uc_twi_busy = 0
#define TWI_clearINT()          TWCR = (1<<TWINT) | (1<<TWEN)
#define TWI_sendACK()           TWCR = (1<<TWINT) | (1<<TWEN) | (1 << TWIE)
#define TWI_sendNACK()          TWCR = (1<<TWINT) | (1<<TWEN)
